...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3A7349);
  late Color secondary = const Color(0xFFBED8AE);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF3A7349);
...
class ThemeTypography extends Typography {
  ...
  String get titleLargeFamily => 'Madimi One';
  ...
  String get labelLargeFamily => 'Madimi One';
  ...
  TextStyle get bodyMedium => GoogleFonts.istokWeb(
        color: theme.primaryText,
