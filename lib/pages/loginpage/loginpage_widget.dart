                  ...
                  children: [
                    Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGINPAGE_PAGE_NavigateBack_ON_TAP');
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'LOGINPAGE_PAGE_forgotPassword_ON_TAP');
                                ...
                                onPressed: () async {
                                  ...
                                  if ((_model.apiResult?.succeeded ?? true)) {
                                    ...
                                    if (valueOrDefault<bool>(
                                      ...
                                      await _model.userTaskSeverList!.reference
                                          .update(createUserTasksRecordData(
                                      ...
                                      FFAppState().IsComplete1 =
                                          _model.userTaskSeverList!.isComplete1;
                                      FFAppState().TaskText2 =
                                          _model.userTaskSeverList!.task2;
                                      FFAppState().Iscomplete2 =
                                          _model.userTaskSeverList!.isComplete2;
                                      FFAppState().TaskText3 =
                                          _model.userTaskSeverList!.task3;
                                      FFAppState().IsComplete3 =
                                          _model.userTaskSeverList!.isComplete3;
                                      FFAppState().TaskRef1 =
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'LOGINPAGE_PAGE_google_ICN_ON_TAP');
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGINPAGE_PAGE_REGISTER_NOW_BTN_ON_TAP');
